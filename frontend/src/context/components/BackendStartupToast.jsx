            ...
            <div className="p-4 sm:p-6">
                ...
                <details className="mb-4 sm:mb-6 group">
                    ...
                    <div className="mt-2 bg-amber-100 rounded-lg p-3 sm:p-4 space-y-1.5 sm:space-y-2">
                        ...
                        <div className="flex items-start gap-1.5 sm:gap-2">
                            <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-amber-500 mt-1.5 flex-shrink-0"></div>
                            <span className="text-xs sm:text-sm text-amber-800">Click "Wake Up" to manually trigger wake-up sequence</span>
                        </div>
                        <div className="flex items-start gap-1.5 sm:gap-2">
                            <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full bg-amber-500 mt-1.5 flex-shrink-0"></div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                    ...
                    <button
                        onClick={onDismiss}
                        className="w-full sm:flex-1 border-2 border-amber-400 hover:bg-amber-100 text-amber-700 font-medium py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg transition-all duration-200 text-sm sm:text-base active:scale-95 cursor-pointer"
                    >
                        Dismiss
                    </button>
